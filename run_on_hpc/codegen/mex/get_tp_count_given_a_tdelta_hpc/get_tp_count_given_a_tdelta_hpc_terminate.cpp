...
//
// get_tp_count_given_a_tdelta_hpc_terminate.cpp
//
...
void get_tp_count_given_a_tdelta_hpc_atexit()
{
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
...
void get_tp_count_given_a_tdelta_hpc_terminate()
{
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

// End of code generation (get_tp_count_given_a_tdelta_hpc_terminate.cpp)
