function [spike_windows] = get_spike_windows_ver_3(ordered_list_of_channels,spikes_per_channel,desired_z_score,desired_number_of_data_points,dir_with_channel_z_scores)
spike_windows = cell(1,384);
for i=1:length(ordered_list_of_channels)
    ...
    disp("get_spike_windows_ver_3.mat Finished " +string(i)+"/"+string(length(ordered_list_of_channels)));
