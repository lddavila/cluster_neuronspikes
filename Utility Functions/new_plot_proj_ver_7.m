function new_plot_proj_ver_4(cluster_filters, aligned, x_axis, y_axis,channels,current_tetrode,z_score,the_number,ideal_representations_list)
channel_string = "";
...
for c = 1:length(cluster_filters)
    ...
    if ismember(c,ideal_representations_list)
        legend_string = [legend_string, "c"+string(c) + " Ideal"];
    else
