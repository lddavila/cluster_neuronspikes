function [has_been_computed] = save_only_the_timestamp(scale_factor,dir_with_channel_recordings,min_z_score,num_dps,timestamps_dir,precomputed_dir,what_is_pre_computed,min_threshold)
...
if ~ismember("dictionaries min_z_score " + string(min_z_score) + " num_dps " + string(num_dps),what_is_pre_computed)
    clc;
    dictionaries_dir = create_a_file_if_it_doesnt_exist_and_ret_abs_path(precomputed_dir+"\dictionaries min_z_score "+string(min_z_score)+ " num_dps "+string(num_dps));
    ...
    dictionaries_dir = precomputed_dir+"\dictionaries min_z_score "+string(min_z_score)+ " num_dps "+string(num_dps);
end
...
if ~ismember("initial_pass",what_is_pre_computed)
    ...
    [output_array,aligned_array,reg_timestamps_array] = run_partial_clustering(array_of_desired_tetrodes,channel_wise_means,channel_wise_std,min_threshold,dir_with_channel_recordings,dictionaries_dir,initial_tetrode_dir,initial_tetrode_results_dir);
