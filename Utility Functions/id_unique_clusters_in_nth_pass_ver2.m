...
for subfolder_counter=1:length(subfolder_names)
    ...
    unique_clusters = {};
    associated_tetrodes = {};
    list_of_outputs = strtrim(string(ls(dir_with_nth_pass_results+"\"+current_subfolder+"\*output.mat"))); %get list of output files
    list_of_reg_timestamps = strtrim(string(ls(dir_with_nth_pass_results+"\"+current_subfolder+"\*reg_timestamps.mat"))); %get the timestamps in seconds
