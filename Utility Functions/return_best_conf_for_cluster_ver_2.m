function [table_of_best_representation] = return_best_conf_for_cluster_ver_2(table_of_overlapping_clusters,table_of_only_neurons,grades_array,debug,timestamp_array,min_overlap_percentage)
...
for i=1:size(table_of_overlapping_clusters,1)
    ...
    overlap_data_dict = table_of_overlapping_clusters{i,"Other Appearence Info"}{1};

    current_overlap_percentages = overlap_data_dict("overlap percentages of other appearences");
    current_other_tetrode_appearences = overlap_data_dict("tetrodes of other appearences");
    current_cluster_other_appearence = overlap_data_dict("cluster number of other appearences");
    classification_of_other_appearences = overlap_data_dict("classification of other appearences");
    current_z_scores_of_other_appearences = overlap_data_dict("Z score of other appearences");
