function [cluster_data, supp_data] = extract_cluster_features_6_channels(raw)
...
%   See also GET_PEAKS, PCA, GET_NEW_PCS.
   ...
   %plot_peaks(peaks.',"in extract cluster features 6 channels.m",[])
...
%     pc1 = pcs(:, :, 1);
    ...
    cluster_data = zscore(peaks.'); % leabes only channels
