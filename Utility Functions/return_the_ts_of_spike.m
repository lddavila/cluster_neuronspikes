function [output, aligned, reg_timestamps,reg_timestamps_of_the_spikes] = return_the_ts_of_spike(raw, timestamps, good_spikes_idx_inj, ir, tvals, filenames, config,channels,iteration_number)
