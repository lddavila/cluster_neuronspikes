...
if ~isfile("table_of_cluster_classification_data.mat") || ~load_previous_attempt
    ...
    if save_results
        save(dir_to_save_to+"\table_of_cluster_classification_data.mat","table_of_cluster_classification");
    end
else
    load(dir_to_save_to+"\table_of_cluster_classification_data.mat","table_of_cluster_classification")
end
...
if isfile("D:\cluster_neuronspikes\Data\aligned_array.mat") && isfile("D:\cluster_neuronspikes\Data\grades.mat") && isfile("D:\cluster_neuronspikes\Data\timestamp_array.mat") && isfile("D:\cluster_neuronspikes\Data\idx.mat")&& load_previous_attempt
    load(dir_to_save_to+"\aligned_array.mat","aligned_array");
    load(dir_to_save_to+"\grades.mat","grades_array");
    load(dir_to_save_to+"\timestamp_array.mat","timestamp_array");
    load(dir_to_save_to+"\idx.mat","idx_array");
else
    ...
    if save_results
        ...
        save(dir_to_save_to+"\timestamp_array.mat","timestamp_array");
...
if isfile("D:\cluster_neuronspikes\Data\table of overlapping clusters.mat") && load_previous_attempt
    load(dir_to_save_to+"\table of overlapping clusters.mat","table_of_overlapping_clusters")
else
    ...
    if save_results
        save(dir_to_save_to+"\table of overlapping clusters.mat","table_of_overlapping_clusters")
    end
end
...
if ~refinement_pass
    ...
    % debug = true;
    if debug
        debug_the_best_representation(best_appearences_of_cluster,generic_dir_with_grades,generic_dir_with_outputs,names_of_grades,grades_that_matter,refinement_pass)
    end
