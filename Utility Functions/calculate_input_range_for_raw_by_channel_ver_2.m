function [array_of_min_max_per_channel] = calculate_input_range_for_raw_by_channel_ver_2(channels_of_current_tetrode,dir_with_channel_recordings)
...
for i=1:length(channels_of_current_tetrode)
    ...
    [min_value,max_value] = bounds(channel_data,"all"); %get the min/max value per channel
