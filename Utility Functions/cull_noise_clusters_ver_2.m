function [clusters_without_noise_clusters] = cull_noise_clusters_ver_2(unique_clusters,associated_tetrodes,dir_with_nth_pass_grades,dir_with_nth_pass_results,plot_the_original_ouput,condition_names_to_use,conditions,values_to_compare_against,min_amplitude)
...
couldnt_load = 0;
clusters_without_noise_clusters = cell(1,length(unique_clusters));
for i=1:length(unique_clusters)
    ...
    if couldnt_load
        ...
        clusters_without_noise_clusters{i} = table_of_only_non_noise_clusters(:,1);
    end
