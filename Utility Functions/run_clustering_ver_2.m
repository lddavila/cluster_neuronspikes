function [final_clusters, bad_clusters] = run_clustering_ver_2(aligned, spike_idx, ir, tvals, refine_spike_idx, config,extract_features_fn)
...
%   'config' is the spikesort configuration struct.
    ...
    raw_clusters = core_cluster_loop(spike_aligned, extract_features_fn, config);
