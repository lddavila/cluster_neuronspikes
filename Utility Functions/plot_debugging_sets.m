function [] = plot_debugging_sets(dir_of_precomputed,table_of_accuracy_of_clusters,min_grade,grades_to_check,plot_the_figures,time_delta)
...
for current_grade_counter=1:length(grades_to_check)
    ...
    for i=1:size(array_of_data,1)
        ...
        if number_of_clusters_representing_same_unit>1
