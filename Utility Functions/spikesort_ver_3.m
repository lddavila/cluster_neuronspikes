function [aligned, cleaned_clusters, grades] = spikesort_ver_3(raw, timestamps, ir, tvals, config,channels,extract_features_fn)
...
%   is the number of grades.
    ...
    clusters = iterative_clustering_ver2(aligned, r_ir, r_tvals, ...
        refine_spike_idx, preproc_idx, config,extract_features_fn);
