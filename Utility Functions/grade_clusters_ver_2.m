function [table_of_cluster_classification] = grade_clusters_ver_2(generic_dir_with_grades,generic_dir_with_outputs,possible_z_scores,list_of_tetrodes_to_check,debug,relevant_grades,relevant_grade_names,dir_to_save_figs_to,refinement_pass)
