function [output_array,aligned_array,reg_timestamps_array,filenames] = run_clustering_algorithm_on_desired_tetrodes_ver_5(list_of_desired_tetrodes,channel_wise_means,channel_wise_std,number_of_std_above_means,dir_with_channel_recordings,dictionaries_dir,inital_tetrode_dir,initial_tetrodes_results_dir,extract_features_fn)
...
for i=1:length(list_of_desired_tetrodes)
    ...
    % try
    [output,aligned,reg_timestamps] = run_spikesort_ntt_core_ver3(raw,timestamps_for_current_tetrode,good_spike_idx,ir,tvals,filenames,config,channels_in_current_tetrode,i,extract_features_fn);
