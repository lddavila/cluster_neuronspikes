...
%% get table of accuracy
clc
[info_from_only_timestamp]=compare_timestamps_to_ground_truth_ver_2(ground_truth_array,unique_clusters,timestamps);
%%
clc;
disp(info_from_only_timestamp)
disp(size(info_from_only_timestamp))
...
clc;
[info_from_timestamp_and_tightness] = compare_timestamps_to_ground_truth_ver_2(ground_truth_array,timestamps_without_noise,timestamps);
...
%% check against ground truths with my tightness conditions applied
clc;
[info_from_timestamp_tightness_and_template_matching] = compare_timestamps_to_ground_truth_ver_2(ground_truth_array,timestamps_without_noise,timestamps);   
