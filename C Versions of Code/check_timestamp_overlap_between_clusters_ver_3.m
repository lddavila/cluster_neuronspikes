function [table_of_other_appearences] = check_timestamp_overlap_between_clusters_ver_3(table_of_neurons,timestamps_cluster_data,min_overlap_percentage,time_delta)
...
for current_neuron_counter=1:size(table_of_neurons,1)
    ...
    for compare_neuron_counter=1:size(table_of_neurons,1)
        ...
        number_of_timestamps_in_common = find_number_of_true_positives_given_a_time_delta(current_neuron_ts,compare_neuron_ts,time_delta);
