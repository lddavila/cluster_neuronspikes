...
%% run the blind pass with a different min_z_score (cut threshold) of 5
precomputed_dir = "D:\spike_gen_data\Recordings By Channel Precomputed";
dir_of_timestamps = "D:\spike_gen_data\Recordings By Channel Timestamps";
for i=1:length(subfolder_names)
    close all;
    ...
    precomputed_dir_current = precomputed_dir +"\"+string(subfolder_names{i});
    what_is_recomputed = ["z_score","mean_and_std"];
    what_is_precomputed = run_entire_clustering_algorithm_ver_2(scale_factor,dir_with_channel_recordings,min_z_score,num_dps,timestamps_dir,precomputed_dir,what_is_precomputed,min_threshold);
end
%% run the blind pass with a different min_z_score (cut threshold) of 6
precomputed_dir = "D:\spike_gen_data\Recordings By Channel Precomputed";
dir_of_timestamps = "D:\spike_gen_data\Recordings By Channel Timestamps";
for i=1:length(subfolder_names)
    close all;
...
%% run the blind pass with a different min_z_score (cut threshold) of 7
precomputed_dir = "D:\spike_gen_data\Recordings By Channel Precomputed";
dir_of_timestamps = "D:\spike_gen_data\Recordings By Channel Timestamps";
for i=1:length(subfolder_names)
    close all;
...
%% run the blind pass with a different min_z_score (cut threshold) of 15
precomputed_dir = "D:\spike_gen_data\Recordings By Channel Precomputed";
dir_of_timestamps = "D:\spike_gen_data\Recordings By Channel Timestamps";
for i=1:length(subfolder_names)
    close all;
...
%% run the blind pass with a different min_z_score (cut threshold) of 1
precomputed_dir = "D:\spike_gen_data\Recordings By Channel Precomputed";
dir_of_timestamps = "D:\spike_gen_data\Recordings By Channel Timestamps";
for i=1:length(subfolder_names)
    close all;
