...
plot_or_dont = 1;
possible_improvement_channels = second_pass_algorithm(dir_with_initial_pass_grades,dir_with_initial_pass_results,manually_made_tetrode,precomputed_dir,min_z_score,num_dps,timestamps_dir,"Messy Example With 2 Channels",20,dir_with_channel_recordings,@extract_cluster_features,config,min_amplitude_distance,plot_or_dont,dir_to_save_figs_to+"spike amplitude graphs");
