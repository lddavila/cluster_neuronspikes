...
//
// find_number_of_true_positives_given_a_time_delta_hpc.cpp
//
...
static emlrtRSInfo emlrtRSI{
    20,                                                     // lineNo
    "find_number_of_true_positives_given_a_time_delta_hpc", // fcnName
    "D:\\cluster_neuronspikes\\run on "
    "HPC\\find_number_of_true_positives_given_a_time_delta_hpc.m" // pathName
};
...
static emlrtRSInfo j_emlrtRSI{
    99,        // lineNo
    "sumprod", // fcnName
    "D:\\MATLABR2024b\\toolbox\\eml\\lib\\matlab\\datafun\\private\\sumprod.m" // pathName
};
...
static emlrtRTEInfo c_emlrtRTEI{
    20,                                                     // lineNo
    17,                                                     // colNo
    "find_number_of_true_positives_given_a_time_delta_hpc", // fName
    "D:\\cluster_neuronspikes\\run on "
    "HPC\\find_number_of_true_positives_given_a_time_delta_hpc.m" // pName
};
...
static emlrtRTEInfo f_emlrtRTEI{
    ...
    5,                                                        // colNo
    "any",                                                    // fName
    "D:\\MATLABR2024b\\toolbox\\eml\\lib\\matlab\\ops\\any.m" // pName
};
    ...
    const emxArray_real_T *ts_of_cluster, real_T time_delta)
{
  ...
  //
  //      % [smallest_difference,~] =
  //      min(abs(diffs_between_gt_ts_and_clust_ts)); if
  //      any(diffs_between_gt_ts_and_clust_ts< time_delta)
  ...
  emxInit_boolean_T(sp, &y, h_emlrtRTEI);
  st.site = &b_emlrtRSI;
  b_st.site = &f_emlrtRSI;
  i = y->size[0] * y->size[1];
  y->size[0] = 1;
  y->size[1] = mat_of_within_time_delta->size[1];
  emxEnsureCapacity_boolean_T(&b_st, y, i, f_emlrtRTEI);
  y_data = y->data;
  ...
  emxFree_boolean_T(&b_st, &mat_of_within_time_delta);
  st.site = &b_emlrtRSI;
