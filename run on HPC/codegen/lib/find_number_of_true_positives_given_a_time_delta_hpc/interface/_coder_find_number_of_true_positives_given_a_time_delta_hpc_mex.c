 ...
 * File: _coder_find_number_of_true_positives_given_a_time_delta_hpc_mex.c
 *
                 ...
                 const mxArray *prhs[])
{
  ...
  unsafe_find_number_of_true_positives_given_a_time_delta_hpc_mexFunction(
      nlhs, plhs, nrhs, prhs);
 ...
 * Return Type  : void
 */
void unsafe_find_number_of_true_positives_given_a_time_delta_hpc_mexFunction(
    int32_T nlhs, mxArray *plhs[1], int32_T nrhs, const mxArray *prhs[3])
{
  ...
  b_prhs[1] = prhs[1];
  b_prhs[2] = prhs[2];
  c_find_number_of_true_positives(b_prhs, &outputs);
...
/*
 * File trailer for
 * _coder_find_number_of_true_positives_given_a_time_delta_hpc_mex.c
 *
 * [EOF]
 */
