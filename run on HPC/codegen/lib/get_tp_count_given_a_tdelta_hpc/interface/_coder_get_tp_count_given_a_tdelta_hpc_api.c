 ...
 * File: _coder_get_tp_count_given_a_tdelta_hpc_api.c
 *
                                     ...
                                     const mxArray **plhs)
{
  ...
  time_delta =
      get_tp_count_given_a_tdelta_hpc(gt_data, ts_of_cluster, time_delta);
...
void get_tp_count_given_a_tdelta_hpc_atexit(void)
{
  ...
  get_tp_count_given_a_tdelta_hpc_xil_terminate();
  get_tp_count_given_a_tdelta_hpc_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_get_tp_count_given_a_tdelta_hpc_api.c
 *
 * [EOF]
 */
