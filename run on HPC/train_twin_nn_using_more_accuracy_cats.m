...
for p=1:size(number_of_accuracy_cats_to_try,2)
    ...
    parfor i=1:size(number_of_layers_to_try,2)
        ...
        for k=1:size(learning_rates_to_try,2)
            ...
            tic;
            [average_accuracy,net]= rate_cluster_quality_nn(number_of_its,mini_batch_size,learning_rate,grad_decay,grady_dec_sq,dir_to_save_train,dir_to_save_test,spikesort_config,num_accuracy_tests,accuracy_batch_size,layers,neurons,[p,i,k]);
            elapsed_time = toc;
