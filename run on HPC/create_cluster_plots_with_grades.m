...
disp(best_appearences_of_cluster);
...
regrade_best_rep_and_plot_output_hpc(gen_dir_with_grades,gen_dir_of_outputs,best_appearences_of_cluster,refinement_pass,grades_to_check,names_of_grades)
cd(home_dir);
disp("Finished")
end