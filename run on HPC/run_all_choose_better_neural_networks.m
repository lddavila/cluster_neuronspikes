function [beginning_of_window,end_of_window] = run_all_choose_better_neural_networks(neural_networks_array,presorted_table,i,blind_pass_table,cluster_size_col,mean_waveform_array,grades_array,config)
max_iterations = 100;
