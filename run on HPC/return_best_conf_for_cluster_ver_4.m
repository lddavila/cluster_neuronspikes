function [table_of_best_representation] = return_best_conf_for_cluster_ver_4(table_of_overlapping_clusters,timestamp_array,min_overlap_percentage,config)
...
table_of_best_representation = table(nan(10000,1),repelem("",10000,1),nan(10000,1),nan(10000,1),nan(10000,1),cell(10000,1),cell(10000,1),'VariableNames',["Z Score","Tetrode","Cluster","SNR","idx of its location in arrays","grades","absorbed_cases"]);
already_appeared = [];
