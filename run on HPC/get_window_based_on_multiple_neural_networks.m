...
parfor i=1:size(blind_pass_table,1)
    ...
    beginning_time = tic;
    [all_window_beginning(i),all_window_end(i)]= run_all_choose_better_neural_networks(neural_networks_array,presorted_table,i,blind_pass_table,cluster_size_col,mean_waveform_array,grades_array,config);
