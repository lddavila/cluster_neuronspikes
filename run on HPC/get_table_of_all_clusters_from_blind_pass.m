function [table_of_all_clusters] = get_table_of_all_clusters_from_blind_pass(config)
...
for i=1:size(z_scores_to_access,2)
    ...
    parfor j=1:size(ordered_list_of_tetrodes,2)
        ...
        %disp("get_table_of_all_clusters_from_blind_pass.m Finished "+"Z Score:"+string(curr_z_sc)+" "+current_tetrode)
    end
...
table_of_all_clusters = vertcat(table_of_all_clusters_cell_array{:});
