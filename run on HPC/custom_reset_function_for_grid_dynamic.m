function [initial_observation,info] =custom_reset_function_for_grid_dynamic(grade_locs_for_presorted,grades_array,blind_pass_table,presorted_grades_array,presorted_table,array_of_training_idxs)

random_sample_index = blind_pass_table{array_of_training_idxs(randi([1,size(array_of_training_idxs,2)],1,1)),"OG_IDX"};
