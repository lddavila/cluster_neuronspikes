...
table_of_cluster_classification = grade_clusters_hpc(generic_dir_with_grades,generic_dir_with_outputs,varying_z_scores,tetrodes_to_check,refinement_pass);
