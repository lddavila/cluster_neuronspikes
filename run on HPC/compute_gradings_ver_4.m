...
all_names_of_all_grades = ["lratio","cv","isi","incompleteness","mahal/isolation distance",...
    ...
    "likeliness of burst","compare wire","2nd compare wire","avg cluster z score","SNR by dimensions","SNR based on best dimensions", "Mean Spike Amplitude Per Channel","Mean Z Score Per Channel Cluster Only","Channels",...
    "Mean Z Score Per Channel all spikes in config"];  
    num_clusters = length(clusters);
    grades = cell(num_clusters, 50);
