...
config.DIR_TO_SAVE_RECLUSTERING_TO ="";
config.SAVE_DIRECTORY = ''; %where any important data will be saved to
config.BLIND_PASS_DIR_PRECOMPUTED = ""; %the parent directory where the blind pass precomputed info is saved (things like spikes per channel and std per channel)
config.TIMESTAMP_FP = "";
config.DIR_WITH_OG_CHANNEL_RECORDINGS = "";
config.DIR_WITH_CHANNEL_WISE_MEANS_AND_STDS = "";
config.GENERIC_GRADES_DIR = ""; % a generic file path which can be modified to access grades of various cluster configurations
config.GENRIC_DIR_WITH_OUTPUTS = ""; %a generic file path which can be modified to access the results of clustering
config.DIR_TO_SAVE_RECLUSTERING_TO ="";
config.GT_FP = "";

config.ON_HPC = false;
config.NUM_DIMS_TO_USE_FOR_RECLUSTERING_ON_HPC = [2 3 4 5 6 7];
config.DIR_TO_SAVE_RECLUSTERING_TO_ON_HPC ="";
config.BLIND_PASS_DIR_PRECOMPUTED_ON_HPC = fullfile(""); %the parent directory where the blind pass precomputed info is saved (things like spikes per channel and std per channel)
config.TIMESTAMP_FP_ON_HPC = "";
config.DIR_WITH_OG_CHANNEL_RECORDINGS_ON_HPC = "";
config.DIR_WITH_CHANNEL_WISE_MEANS_AND_STDS_ON_HPC ="";
config.GENERIC_GRADES_DIR_ON_HPC = ""; % a generic file path which can be modified to access grades of various cluster configurations
config.GENRIC_DIR_WITH_OUTPUTS_ON_HPC = ""; %a generic file path which can be modified to access the results of clustering
config.FP_TO_GT_FOR_RECORDING_ON_HPC = "";
config.FP_TO_TABLE_OF_BEST_CHANNELS = "";
...
config.DIR_TO_SAVE_CLUSTER_IMAGE_PNGS_TO ="";
config.DIR_TO_SAVE_CLUSTER_IMAGE_PNGS_TO_ON_HPC ="";

config.FP_TO_TABLE_OF_ALL_BP_CLUSTERS= ""; %needs to be set
config.FP_TO_TABLE_OF_ALL_BP_CLUSTERS_ON_HPC = "";

%
config.WHICH_NEURAL_NET = "";
config.DIR_TO_SAVE_ACC_RESULTS_TO ="";
config.DIR_TO_SAVE_ACC_RESULTS_TO_ON_HPC = "";

config.DIR_WITH_NUMBER_BASED_IMAGES = "";
config.DIR_WITH_NUMBER_BASED_IMAGES_ON_HPC = "";


config.FP_TO_ACC_PREDICTING_NN = ""; %needs to be set 
config.FP_TO_ACC_PREDICTING_NN_ON_HPC = ""; %needs to be set

config.FP_TO_QUALITY_PREDICTING_NN = ""; %needs to be set
config.FP_TO_QUALITY_PREDICTING_NN_ON_HPC = "";

config.FP_TO_MUA_OR_NOT_PREDICTING_NN ="" ; % needs to be set
config.FP_TO_MUA_OR_NOT_PREDICTING_NN_ON_HPC ="";

config.FP_TO_EXPAND_OR_DONT_NN ="" ; %needs to be set 
...
config.USE_SNR_DIMS = false; %false is the default

config.twin_nn_training_data = "";
config.twin_nn_training_data_on_hpc = "";

config.twin_nn_test_data = "";
config.twin_nn_test_data_on_hpc = "";

config.parent_save_dir = "";%needs to be set
config.parent_save_dir_ON_HPC = '';
...
config.FP_TO_TWIN_NN_PREDICTOR = ""; %needs to be set
config.FP_TO_TWIN_NN_PREDICTOR_ON_HPC = "";

config.DIR_TO_ACC_CAT_IMAGES = "";
...
% dir.
config.SAVE_DIRECTORY = '';%needs to be set
