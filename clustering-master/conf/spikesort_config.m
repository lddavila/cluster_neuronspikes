...
config.ON_HPC = contains(pwd,"lddavila","IgnoreCase",true)|| contains(pwd,"cnheaton","IgnoreCase",true) ; 
...
config.FP_TO_TABLE_OF_ALL_BP_CLUSTERS_ON_HPC = "/scratch/cnheaton/data_from_local_machine/final_table_with_overlap_only_neurons.mat";

%
config.WHICH_NEURAL_NET = "under_unit_count";
...
config.FP_TO_EXPAND_OR_DONT_NN ="D:\cluster_neuronspikes\expand_or_dont_NN\accuracy score 94.5545 num layers 22 filter size 256 expand_or_dont.mat" ;
...
config.FP_TO_ALREADY_DONE_ON_HPC= "/scratch/cnheaton/data_from_local_machine/Already Done Neural Networks/already_done_twin_nn_choose_better.mat";
...
config.DIR_TO_SAVE_RESULTS_TO = "08_03_predict_over_one_count";
...
config.FP_TO_COMPLEX_MERGE_OR_DONT_NN = "D:\cluster_neuronspikes\Data\06_17_2025_complex_merge_nn_with_overlap\accuracy score 0.99367 num layers 1 num neurons per layer15 complex merge checker.mat";
config.FP_TO_COMPLEX_MERGE_OR_DONT_NN_ON_HPC = "/scratch/lddavila/data_from_local_machine/06_18_2025_complex_choose_better/accuracy score 0.85031 num layers 13 num neurons per layer10 complex choose better.mat'";
...
config.FP_TO_COMPLEX_CHOOSE_BETTER_NN_ON_HPC =  "/scratch/lddavila/data_from_local_machine/06_18_2025_complex_choose_better/accuracy score 0.85031 num layers 13 num neurons per layer10 complex choose better.mat";
...
config.FPS_OF_STRUCTURED_CHOOSE_BETTER_NEURAL_NETS_ON_HPC= ["/scratch/lddavila/data_to_copy_to_local_machine/07_03_2025_comp_ch_better_shrt_names/Ranging Between 100 90/a_s 1 n_l 11 n_n_p_l20 c_c_b_acc_diff 100 90  80.5754 .mat",...
    "/scratch/lddavila/data_to_copy_to_local_machine/07_03_2025_comp_ch_better_shrt_names/Ranging Between 90 80/a_s 0.99028 n_l 1 n_n_p_l30 c_c_b_acc_diff 90 80  34.7165 .mat",...
    "/scratch/lddavila/data_to_copy_to_local_machine/07_03_2025_comp_ch_better_shrt_names/Ranging Between 70 60/a_s 0.98992 n_l 1 n_n_p_l50 c_c_b_acc_diff 70 60  23.969 .mat",...
    "/scratch/lddavila/data_to_copy_to_local_machine/07_03_2025_comp_ch_better_shrt_names/Ranging Between 60 50/a_s 0.95272 n_l 1 n_n_p_l10 c_c_b_acc_diff 60 50  33.3521 .mat",...
    "/scratch/lddavila/data_to_copy_to_local_machine/07_03_2025_comp_ch_better_shrt_names/Ranging Between 30 20/a_s 0.89951 n_l 18 n_n_p_l50 c_c_b_acc_diff 30 20  75.4688 .mat",...
    "/scratch/lddavila/data_to_copy_to_local_machine/07_03_2025_comp_ch_better_shrt_names/Ranging Between 20 10/a_s 0.81213 n_l 24 n_n_p_l50 c_c_b_acc_diff 20 10  108.2946 .mat",...
    "/scratch/lddavila/data_to_copy_to_local_machine/07_03_2025_comp_ch_better_shrt_names/Ranging Between 10 5/a_s 0.68417 n_l 13 n_n_p_l15 c_c_b_acc_diff 10 5  62.9002 .mat",...
    "/scratch/lddavila/data_to_copy_to_local_machine/07_03_2025_comp_ch_better_shrt_names/Ranging Between 2 1/a_s 0.55977 n_l 8 n_n_p_l50 c_c_b_acc_diff 2 1  87.605 .mat"];
