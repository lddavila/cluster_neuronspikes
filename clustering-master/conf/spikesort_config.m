...
config.DEBUG_DAVID = true; % used by various functions, and will print plots, used for debugging
...
config.NAMES_OF_CURR_GRADES =["lratio","cv","short isi","incompleteness compare wire","mahal/isolation distance compare wire",...
    ...
    "Prediction of accuracy based on image","prediction of cluster quality based on image","MUA or Not","Expand Or Dont"];
...
config.DIR_TO_SAVE_ACC_RESULTS_TO ="/home/lddavila/data_from_local_server/vacuum_spikes_array_results";
